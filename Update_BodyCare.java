...
import java.sql.*;
public class Update_BodyCare extends javax.swing.JFrame {

    Connection con;
    ResultSet rs;
    PreparedStatement pst=null;
    Statement stmt;
    public Update_BodyCare() {
        initComponents();
    ...
    private void delBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delBtnActionPerformed
        ...
        try
        {
            ...
            String sql="DELETE FROM bodycare WHERE Sno="+sno+";";
                ...
                try
                 {
                    ...
                    con= DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_mgt","root",""); 
                    stmt=con.createStatement();
                    String sql="INSERT INTO bodycare(Sno,Size,CupSize,Qty,Price) VALUES (?,?,?,?,?);";
    ...
    private void CB1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CB1ActionPerformed
        ...
        try
        {
            ...
            con= DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_mgt","root","");
            stmt=con.createStatement();
            String sql="SELECT Sno FROM bodycare;";
           // String sql="SELECT * FROM lovinoform where Sno='" + CB1.getSelectedItem() +" ' ;";
        ...
        try
        {
            ...
            con= DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_mgt","root","");
            stmt=con.createStatement();
            String sql="SELECT * FROM bodycare where Sno='" + CB1.getSelectedItem() +" ' ;";
            rs=stmt.executeQuery(sql);
            while(rs.next())
            {
            ...
            try
                 {
                    ...
                    con= DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_mgt","root",""); 
                    stmt=con.createStatement();
                    String sql="UPDATE bodycare SET Sno='"+ sno +"',Size='"+ size +"',CupSize='"+csize+"',Qty='"+qty+"',Price='"+ price +"' where Sno='"+snoTF.getText()+"' ;";       
