 ...
 * @author Megha
 */
public class BodyCare extends javax.swing.JFrame {

    /**
     * Creates new form BodyCare
     */
    public BodyCare() {
        initComponents();Date dt=new Date();
         ...
         try
            {
              ...
              //  JOptionPane.showMessageDialog(null," Connected");
                String sql="SELECT * FROM bodycare;";
    ...
    private void delBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delBtnActionPerformed
        // TODO add your handling code here:
        new Update_BodyCare().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BodyCare.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
