 ...
 * @author Megha
 */
public class Souminie extends javax.swing.JFrame {

    /**
     * Creates new form Souminie
     */
    public Souminie() {
        initComponents();
        Date dt=new Date();
    ...
    private void showBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showBtnActionPerformed
          ...
          ;
                    String sql="SELECT * FROM souminie;";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Souminie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
