...
public class Update_Kalyani extends javax.swing.JFrame {
    ...
    private void delBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delBtnActionPerformed
        ...
        try
        {
            ...
            String sql="DELETE FROM kalyani WHERE Sno="+sno+";";
                ...
                try
                 {
                    ...
                    con= DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_mgt","root",""); 
                    stmt=con.createStatement();
                    String sql="INSERT INTO kalyani(Sno,Size,CupSize,Qty,Price) VALUES (?,?,?,?,?);";
    ...
    private void CB1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CB1ActionPerformed
        ...
        try
        {
            ...
            con= DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_mgt","root","");
            stmt=con.createStatement();
            String sql="SELECT Sno FROM kalyani;";
        ...
        try
        {
            ...
            con= DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_mgt","root","");
            stmt=con.createStatement();
            String sql="SELECT * FROM kalyani where Sno='" + CB1.getSelectedItem() +" ' ;";
            rs=stmt.executeQuery(sql);
            while(rs.next())
            {
            ...
            try
                 {
                    ...
                    con= DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_mgt","root",""); 
                    stmt=con.createStatement();
                    String sql="UPDATE kalyani SET Sno='"+ sno +"',Size='"+ size +"',CupSize='"+csize+"',Qty='"+qty+"',Price='"+ price +"' where Sno='"+snoTF.getText()+"' ;";       
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Update_Kalyani().setVisible(true);
