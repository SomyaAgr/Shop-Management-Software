...
public class Update_Lovinoform extends javax.swing.JFrame {

    /**
     * Creates new form Update_Lovinoform
     */
    Connection con;
    ResultSet rs;
    PreparedStatement pst=null;
    Statement stmt;
    public Update_Lovinoform() {
        initComponents();
    ...
    private void delBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delBtnActionPerformed
        ...
        try
        {
            ...
            String sql="DELETE FROM lovinoform WHERE Sno="+sno+";";
                ...
                try
                 {
                    ...
                    con= DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_mgt","root",""); 
                    stmt=con.createStatement();
                    String sql="INSERT INTO lovinoform(Sno,Size,CupSize,Qty,Price) VALUES (?,?,?,?,?);";
    ...
    private void CB1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CB1ActionPerformed
        ...
        try
        {
            ...
            con= DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_mgt","root","");
            stmt=con.createStatement();
            String sql="SELECT Sno FROM lovinoform;";
            ...
            try
                 {
                    ...
                    con= DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_mgt","root",""); 
                    stmt=con.createStatement();
                    String sql="UPDATE lovinoform SET Sno='"+ sno +"',Size='"+ size +"',CupSize='"+csize+"',Qty='"+qty+"',Price='"+ price +"' where Sno='"+snoTF.getText()+"' ;";       
