...
public class Update_Rajnee extends javax.swing.JFrame {

    /**
     * Creates new form Update_Rajnee
     */
    Connection con;
    ResultSet rs;
    PreparedStatement pst=null;
    Statement stmt;
    public Update_Rajnee() {
        initComponents();
    ...
    private void delBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delBtnActionPerformed
        ...
        try
        {
            ...
            String sql="DELETE FROM rajnee WHERE Sno="+sno+";";
                ...
                try
                 {
                    ...
                    con= DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_mgt","root",""); 
                    stmt=con.createStatement();
                    String sql="INSERT INTO rajnee(Sno,Size,CupSize,Qty,Price) VALUES (?,?,?,?,?);";
    ...
    private void CB1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CB1ActionPerformed
        ...
        try
        {
            ...
            con= DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_mgt","root","");
            stmt=con.createStatement();
            String sql="SELECT Sno FROM rajnee;";
        ...
        try
        {
            ...
            con= DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_mgt","root","");
            stmt=con.createStatement();
            String sql="SELECT * FROM rajnee where Sno='" + CB1.getSelectedItem() +" ' ;";
            rs=stmt.executeQuery(sql);
            while(rs.next())
            {
            ...
            try
                 {
                    ...
                    con= DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_mgt","root",""); 
                    stmt=con.createStatement();
                    String sql="UPDATE rajnee SET Sno='"+ sno +"',Size='"+ size +"',CupSize='"+csize+"',Qty='"+qty+"',Price='"+ price +"' where Sno='"+snoTF.getText()+"' ;";       
